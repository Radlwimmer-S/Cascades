...
void ParticleSystem::Update(GLfloat deltaTime, const UpdateInfo& info)
{
	if (m_particleCount == 0)
		return;

	m_updateShader->Use();
	UpdateUniformsU(deltaTime, info);
...
void ParticleSystem::UpdateUniformsU(GLfloat deltaTime, const UpdateInfo& info)
{
